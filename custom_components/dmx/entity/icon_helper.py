...
def determine_icon(channel: Channel) -> str:
    ...
    priority_order = [
        'ColorPreset', 'ColorIntensity', 'ColorTemperature',
        'ShutterStrobe', 'StrobeSpeed', 'StrobeDuration',
        'Pan', 'Tilt', 'PanContinuous', 'TiltContinuous',
        'Effect', 'EffectSpeed', 'EffectDuration',
        'Intensity',
        'WheelSlot', 'WheelRotation', 'Rotation',
        'Focus', 'Zoom', 'BeamAngle',
        'Fog', 'FogOutput',
        'Generic', 'Maintenance'
    ]
