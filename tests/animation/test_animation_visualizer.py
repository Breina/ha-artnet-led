...
def plot_animation_data(captured_frames,
                        hass,
...
async def test_rgb_fade_animation(mock_hass):
    ...
    await animate(engine, channel_mappings,
...
async def test_rgbww_fade_animation(mock_hass):
    ...
    await animate(engine, channel_mappings,
                  {ChannelType.RED: 255, ChannelType.GREEN: 0, ChannelType.BLUE: 0, ChannelType.COLD_WHITE: 0, ChannelType.WARM_WHITE: 255},
                  {ChannelType.RED: 0, ChannelType.GREEN: 0, ChannelType.BLUE: 255, ChannelType.COLD_WHITE: 255, ChannelType.WARM_WHITE: 0}
                  )

    await animate(engine, channel_mappings,
                  {ChannelType.RED: 0, ChannelType.GREEN: 0, ChannelType.BLUE: 255, ChannelType.COLD_WHITE: 255, ChannelType.WARM_WHITE: 0},
                  {ChannelType.RED: 255, ChannelType.GREEN: 255, ChannelType.BLUE: 255, ChannelType.COLD_WHITE: 0, ChannelType.WARM_WHITE: 0}
                  )

    await animate(engine, channel_mappings,
                  {ChannelType.RED: 255, ChannelType.GREEN: 255, ChannelType.BLUE: 255, ChannelType.COLD_WHITE: 0, ChannelType.WARM_WHITE: 0},
                  {ChannelType.RED: 0, ChannelType.GREEN: 0, ChannelType.BLUE: 0, ChannelType.COLD_WHITE: 255, ChannelType.WARM_WHITE: 255}
                  )
...
async def animate(engine, channel_mappings, current_values, desired_values, min_kelvin: int = 2700, max_kelvin: int = 6500):
